...
urlpatterns = [
    ...
    path('api/class-based/article-list/', acv.ArticleAPIView.as_view(), name='articleList-classBased'),   # since it's a class-based API, require to mention ".as_views()" explicitly.
]